...
$(".trigger2").click(function(){
    $(this).find('.switch-in').toggleClass('switch-in1');
    $(this).find('.switch-in2').toggleClass('switch-in3');
});


/*$('.lift').click(function() {
    $('.recover_list').hide(300);
    $('.lift_in').show(300);
});*/

$('.lift').click(function() {
    if ($('.recover_list').css("display")=="block") {$('.recover_list').css("display", "none");
        $('.lift_in').css("display", "block");
    } else {$('.lift_in').css("display", "none");
            $('.recover_list').css("display", "block");}
});
/************selectbox*************/
...
/******************bubble******************/
$('.p1').mouseenter(
    function() {$(this).find('.bubble').fadeIn(10);}
);
$('.p1').mouseleave(
    function() {$(this).find('.bubble').fadeOut(10);}
);
$('.project-details').mouseenter(
    function() {$(this).find('.bubble').css("display", "block");}
);
$('.project-details').mouseleave(
    function() {$(this).find('.bubble').css("display", "none");}
);
/****************anchors_scrolling**********************/
// Cache selectors
var lastId,
    topMenu = $(".anchors_cont"),
    topMenuHeight = topMenu.outerHeight()-210,
// All list items
...
menuItems.click(function(e){
    var href = $(this).attr("href"),
        ...
        $elemOn = $('.one.on'),
        $elemOff = $('.one.off'),
        $menu = document.getElementsByClassName("example");
